...
![img](../../pics/apue-standardio-16.png)
...
![img](../../pics/apue-standardio-21.png)
...
![img](../../pics/apue-standardio-27.png)
...
![img](../../pics/apue-processenv-3.png)
...
![img](../../pics/apue-processenv-1.png)
...
![img](../../pics/apue-processenv-2.png)
...
![img](../../pics/apue-processenv-4.png)
...
![img](../../pics/apue-processenv-7.png)
...
![img](../../pics/apue-processenv-8.png)
...
![img](../../pics/apue-processenv-9.png)
...
![img](../../pics/apue-processenv-10.png)
...
![img](../../pics/apue-processenv-5.png)
...
![img](../../pics/apue-processenv-13.png)
...
![img](../../pics/apue-processenv-18.png)
...
![img](../../pics/apue-processenv-19.png)
...
![img](../../pics/apue-processenv-14.png)
...
![img](../../pics/apue-processenv-6.png)
...
![img](../../pics/apue-processenv-15.png)
...
![img](../../pics/apue-processenv-16.png)



1. 随着对内存不断地释放和重新分配，空闲列表中的空闲内存会和已分配的在用内存混杂在一起



![img](../../pics/apue-processenv-17.png)
...
![img](../../pics/apue-processenv-11.png)
...
- 参数
  ...
  ![img](../../pics/apue-processenv-12.png)
...
![img](../../pics/apue-processctr-1.png)
...
![img](../../pics/apue-processctr-2.png)
...
- 注意父子进程的**文件描述符**：
  ...
  ![img](../../pics/apue-processctr-3.png)
...
![img](../../pics/apue-processctr-4.png)
...
- 参数
  ...
  - `statloc`：如果关心终止状态就传入一个int变量的地址，终止状态将存于其中；不关心终止状态可以设为NULL。该整形状态字是由实现定义的：
    - 某些位表示退出状态（正常返回）
    - 某些位指示信号编号（异常返回）
    - 有一位指示是否产生了core文件 可以使用POSIX.1规定，终止状态用定义在``中的宏来查看，下图4个互斥的宏可用来取得进程终止的原因。基于这4个宏中哪一个值为真，就可选用其它宏来取得退出状态，信号编号等：

  

  ![img](../../pics/apue-processctr-5.png)
  ...
  ![img](../../pics/apue-processctr-6.png)
...
![img](../../pics/apue-processctr-7.png)
...
![img](../../pics/apue-processctr-8.png)
...
![img](../../pics/apue-processctr-9.png)
...
![img](../../pics/apue-processctr-13.png)
...
![img](../../pics/apue-processctr-10.png)
...
![img](../../pics/apue-processctr-11.png)
...
![img](../../pics/apue-processctr-14.png)
...
![img](../../pics/apue-processctr-12.png)
...
![img](../../pics/apue-processctr-15.png)
...
![img](../../pics/apue-processctr-16.png)
...
![img](../../pics/apue-processctr-17.png)
...
![img](../../pics/apue-processctr-18.png)
...
![img](../../pics/apue-processctr-19.png)
...
![img](../../pics/apue-processctr-20.png)
...
![img](../../pics/apue-threadctr-23.png)
...
![img](../../pics/apue-threadctr-24.png)
...
![img](../../pics/apue-threadctr-25.png)
...
![img](../../pics/apue-threadctr-26.png)
...
![img](../../pics/apue-threadctr-22.png)
...
1）检查系统中是否定义了`_POSIX_THREAD_PROCESS_SHARED`符号判断这个平台是否支持进程共享这个属性； 2）可以在运行时把`_SC_THREAD_PROCESS_SHARED`参数传给`sysconf`函数进行检查）



![img](../../pics/apue-threadctr-9.png)
...
![img](../../pics/apue-threadctr-10.png)
...
![img](../../pics/apue-threadctr-11.png)
...
![img](../../pics/apue-threadctr-12.png)
...
![img](../../pics/apue-threadctr-13.png)
...
![img](../../pics/apue-threadctr-14.png)
...
![img](../../pics/apue-threadctr-15.png)
...
![img](../../pics/apue-threadctr-16.png)
...
![img](../../pics/apue-threadctr-17.png)
...
![img](../../pics/apue-threadctr-18.png)
...
![img](../../pics/apue-threadctr-19.png)
...
![img](../../pics/apue-threadctr-20.png)
...
![img](../../pics/apue-threadctr-21.png)
...
![img](../../pics/apue-threadctr-27.png)
...
![img](../../pics/apue-threadctr-28.png)
...
![img](../../pics/apue-threadctr-29.png)
...
![img](../../pics/apue-threadctr-30.png)
...
![img](C:/Users/Administrator/Desktop/%E7%9F%A5%E8%AF%86%E7%82%B9/1.%20%E4%B9%A6%E7%B1%8D%E7%9F%A5%E8%AF%86%E6%80%BB%E7%BB%93/%EF%BC%88%E4%B9%A6%E7%B1%8D%EF%BC%89note-master/note-master/pic/apue-advio-1.png)
...
![img](C:/Users/Administrator/Desktop/%E7%9F%A5%E8%AF%86%E7%82%B9/1.%20%E4%B9%A6%E7%B1%8D%E7%9F%A5%E8%AF%86%E6%80%BB%E7%BB%93/%EF%BC%88%E4%B9%A6%E7%B1%8D%EF%BC%89note-master/note-master/pic/apue-advio-3.png)
...
- 当执行`fcntl(F_SETLK,flockptr)`，而`flockptr->l_type=F_WRLCK`， `flockptr->l_whence=SEEK_END`，`flockptr->l_start=0`，`flockptr->l_len=0` 时，表示从当前文件尾端开始，包括以后所有可能追加写到该文件的任何字节都将加写锁
- 然后执行`write`一个字节时，该字节将被加锁
- 当执行 `fcntl(F_SETLK,flockptr)`，而`flockptr->l_type=F_UNLCK`， `flockptr->l_whence=SEEK_END`，`flockptr->l_start=0`，`flockptr->l_len=0` 时，表示从当前文件尾端开始解锁，但是之前刚写入的一个字节仍然保持在加锁状态！！
...
- `off`的值和`addr`的值（如果指定了`MAP_FIXED`）通常被要求是系统虚拟存储页长（虚拟存储页长可以用带参数`_SC_PAGESIZE`或者`_SC_PAGE_SIZE`的`sysconf`函数得到 ）的倍数。因为`off`和`addr`通常指定为 0 ，所以这种要求一般并不重要

下图是存储映射文件的基本情况。其中“起始地址”是`mmap`的返回值



![img](../../pics/apue-advio-16.png)
...
**标识符是IPC对象的内部名**。为使多个合作进程能够在同一IPC对象上汇聚，需要提供一个外部命名方案。为此，**每个IPC对象都与一个键相关联，将这个键作为该对象的外部名**（创建IPC结构时，应指定一个键）。**键的类型是基本系统数据类型`key_t`**，通常在``中被定义为长整形。这个键由内核变换成标识符

### 4.2 权限结构

每个IPC结构关联了一个`ipc_perm`结构（``），规定了权限和所有者，至少包括以下成员：
...
- `cmd`
  ...
  - `IPC_RMID`：从系统中删除该共享存储段。因为每个共享存储段维护着一个连接计数(`shmid_ds`中的`shm_nattach`字段)，所以除非使用该段的最后一个进程终止或与该段分离，否则不会实际上删除该存储段。不管此段是否仍在使用，该段标识符都会被立即删除，所以不能再用`shmat`与该段连接（此命令只能由下列2种进程执行：1）其有效ID等于shm_perm.cuid或shm_perm.uid；2）具有超级用户特权的进程；） Linux和Solaris提供了另外两种命令，但它们并非Single UNIX Specification的组成部分

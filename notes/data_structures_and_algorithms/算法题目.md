...
| 一   | 二 |      |      |      |  | 七 | 八 |      |      |
| :----: | :--: | ---- | ---- | ---- | ---- | :--: | :--: | ---- | ---- |
| [数组](#array) | [字符串](#字符串) |      |      |      |      | [图](#graph) | [设计](#设计) |      |      |
...
- **二.字符串**
  ...
  - *字符串转换*
    ...
    1. Leetcode91：[数字字符串解码](#数字字符串解码)（`动态规划` `medium`）

    2. Leetcode127：[单词阶梯](#单词阶梯)（`BFS` `medium`）

    3. Lintcode119：[单词转换的最少次数](#单词转换的最少次数)（`动态规划` `medium`）

  - *子串与子序列*

       1. Leetcode28：[子串查找](#子串查找)（`KMP` `easy`）
...
- 遍历
  ...
  1. 《剑指offer》面试题13：[机器人的运动范围](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#机器人的运动范围)（`DFS`）
  
  2. Leetcode62：[左上角到右下角的路径数](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#左上角到右下角的路径数)（`DFS` `动态规划` `medium`）
  
  3. Leetcode63：[左上角到右下角的路径数II](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#左上角到右下角的路径数ii)（`DFS` `动态规划` `medium` ）
  
  4. Leetcode64：[左上角到右下角的最短路径](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#左上角到右下角的最短路径)（`DFS` `动态规划` `medium` ）
  
  5. Leetcode130：[被包围的区域](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#被包围的区域)（`DFS` `medium`）
  
  6. Leetcode200：[岛屿的数量](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#岛屿的数量)（`DFS` `easy`）
  
  7. Leetcode695：[岛屿的最大面积](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#岛屿的最大面积)（`DFS` `easy`）
  
  8. Leetcode329：[矩阵中的最长递增路径](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#矩阵中的最长递增路径)（`DFS` `动态规划` `hard`）
  
  9. Leetcode55：[跳步游戏](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#跳步游戏)（`贪心` `medium`）
  
  10. Leetcode45：[跳步游戏II](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#跳步游戏ii)（`动态规划` `BFS` `hard`）
  
- 拓扑排序
  
  11. Leetcode207：[课程安排](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#课程安排)（`BFS` `DFS` `medium`）
  
  12. Leetcode210：[课程安排II](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#课程安排ii)（`BFS` `DFS` `medium`）
  
- 最短路径
  
  13. hihoCoder1081：[Dijkstra算法](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#dijkstra算法)（`dijkstra` `Lv.2`）
  
- 最小生成树
  
  14. hihoCoder1097：[连通所有城市的最短道路](https://github.com/arkingc/note/blob/master/数据结构与算法/算法题总结.md#连通所有城市的最短道路)（`prim` `Lv.2`）

<a name="设计"></a>

**八.图**

​		2. Leetcode208：**实现Trie树(前缀树)**（`Trie` `设计` `medium`）
